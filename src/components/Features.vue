    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
          <button type="button" class="btn btn-primary btn-lg px-4 me-md-2" fdprocessedid="sui7iw">Primary</button>
          <button type="button" class="btn btn-outline-secondary btn-lg px-4" fdprocessedid="603gz">Default</button>
        </div>
      </div>
    </div>
  </div>
